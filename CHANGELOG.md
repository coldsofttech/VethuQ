...
- The desktop app's Sources view now lets you right-click a source to index it now, retry its failed files, pause/resume or stop the background run, and view past run history.
